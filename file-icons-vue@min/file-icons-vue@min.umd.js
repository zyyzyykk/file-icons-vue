(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["file-icons-vue@min"] = factory(require("vue"));
	else
		root["file-icons-vue@min"] = factory(root["Vue"]);
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-86.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/package/file-icons.vue?vue&type=script&lang=js
...
var exportHelper = __webpack_require__(4291);
...
const IMAGE_MAP = __webpack_require__(761);
const DEF_prefix = "icons";
const DEF_floder = "floder";
const DEF_null = "kk";
const DEF_BasePath = "./";
const $definedMap = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.ref)(new IconCacheMap("ROOT", {}));
...
.${prefix}-files-classed {
  ...
  const _vnode = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)('style', {
    type: "text/css",
...
const renderForce = (el, definedMap, prefix) => {
  ...
  (0,external_commonjs_vue_commonjs2_vue_root_Vue_.render)($vnode, $el);
  $el.$vnode = $vnode;
};
//
const cachedIcon = ({
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-86.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/package/classed-file-icons.vue?vue&type=script&setup=true&lang=js
...
/* harmony default export */ var classed_file_iconsvue_type_script_setup_true_lang_js = ({
  ...
  setup(__props) {
    ...
    const $prefix = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toValue)($props).prefix;
    });
    const $el = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      return getDom((0,external_commonjs_vue_commonjs2_vue_root_Vue_.toValue)($props).el);
    });
    const $definedMap = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      return getDefinedMap($el.value);
    });
    let ext = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      let props = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.unref)($props);
      return getExt(props);
    });
    let icon = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      return getIcon(ext.value);
    });
    let computedStyle = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
      let props = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.unref)($props);
      return {
        width: props.width,
        height: props.height,
    ...
    let computedClass = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.computed)(() => {
    ...
    return (_ctx, _cache) => {
      return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", {
        class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)((0,external_commonjs_vue_commonjs2_vue_root_Vue_.unref)(computedClass)),
        style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)((0,external_commonjs_vue_commonjs2_vue_root_Vue_.unref)(computedStyle))
      }, null, 6);
    };
  }
});
...
const useIcon = props => {
  ...
  const app = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createApp)(() => renderForce($el, $definedMap));
...
//# sourceMappingURL=file-icons-vue@min.umd.js.map